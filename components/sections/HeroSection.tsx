    ...
    <section ref={ref} className="relative h-screen min-h-[600px] flex items-center overflow-hidden">
      ...
      <div className="section-container relative z-10 pt-16">
        ...
        >
          {t.hero.headline1}
          <br />
          <em className="text-hob-gold italic">{t.hero.headlineItalic}</em>
          <br />
          {t.hero.headline2}
        </m.h1>
        ...
        >
          ...
          <span className="font-[family-name:var(--font-josefin)] text-[8px] tracking-[0.3em] text-hob-muted uppercase">{t.hero.scroll}</span>
        </m.div>
      </div>
    </section>
  );
